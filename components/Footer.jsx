...
const Footer = () => {
  ...
  const support = ["Contact Us", "Seller Support", "Privacy Policy", "Terms of Service"];
        ...
        <div className="elai-shell">
          <div className="footer-brand-col">
            ...
            <p className="footer-tagline">
              India&apos;s All-in-One Accessories Marketplace. Every accessory. One platform.
            </p>
          ...
          <div className="footer-bottom">
            <div className="footer-copyright">© 2026 Elai. All rights reserved.</div>
            <div className="footer-credit">
              Built by{" "}
              <a href="https://www.baw.studio" target="_blank" rel="noreferrer" style={{ color: "#748956", fontWeight: "bold" }}>
                BAW Studio
              </a>
            </div>
          </div>
